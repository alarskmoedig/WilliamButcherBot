...
<h1>
    <p align="center">
        <a href="https://heroku.com/deploy?template=https://github.com/alarskmoedig/WilliamButcherBot">
...
```console
thehamkercat@arch:~$ git clone https://github.com/alarskmoedig/WilliamButcherBot
thehamkercat@arch:~$ cd WilliamButcherBot
